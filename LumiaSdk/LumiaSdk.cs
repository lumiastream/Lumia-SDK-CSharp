...
namespace Lumia
{
	...
	public class LumiaSdk
	{
		...
		// Sends game event
		public Task<JObject> SendGameEvent(string event_name, object value = null)
		{

			ILumiaSdkSendPack pack = new ILumiaSdkSendPack();
			pack.type = LumiaUtils.getTypeValue<LumiaSDKCommandTypes>(LumiaSDKCommandTypes.GAME);
			pack.params_ = new LumiaSDKPackParams();
			pack.params_.event_name = event_name;
